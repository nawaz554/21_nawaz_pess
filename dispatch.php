<?php
	...
	$descriptionOfIncident =  $_POST["descriptionOfIncident"]; 
		...
		$sql = "INSERT INTO `incident`( `caller_name`, `phone_number`, `incident_type_id`, `incident_location`, `incident_desc`, `incident_status_id`, `time_called`) VALUES 
		('" . $callerName .  "','" . $contactNo . "','" . $typeOfIncident . "','" . $locationOfIncident . "','" . $descriptionOfIncident . "','" . $incidentStatus . "',now())";
		//echo $sql; 
		...
		foreach($patrolcarDispatched as $eachCarId) {
			...
			$sql = "UPDATE `patrolcar` SET `patrolcar_status_id`=1 WHERE 
			`patrolcar_id`='" . $eachCarId . "'";
			...
			$sql = "INSERT INTO `dispatch`(`incident_id`, `patrolcar_id`, `time_dispatched`) VALUES (" . $incident_id . ",'" . $eachCarId . "',now())";
